...
避免过度霓虹、无来源光束、夸张爆炸、随机文字、悬浮建筑、透视冲突、塑料材质、过饱和青橙调色、背景尺度错误、人物像贴上去、头身比例失衡、僵硬动作和过量烟雾。`,
    ...
    },
    {
        ...
        prompt: '复古海报感的极简概念插画风格。以大块概括性形体、简化轮廓、清晰明暗分组和层叠色面塑造主体与空间；融合数字厚涂、不透明水粉与干刷笔触，保留手绘边缘、轻微飞白和细腻纸张颗粒。使用低饱和有限色盘，以奶油白、雾蓝、橄榄绿、黄褐、砖红和炭黑构成温暖、克制、略带褪色印刷感的色彩。构图强调清晰视觉中心、尺度对比、负空间与引导线，呈现宁静、辽阔、具有电影感的环境概念艺术气质。',
        promptEn: 'Minimalist concept illustration with the character of a vintage poster. Shape the subject and space with broad simplified forms, reduced silhouettes, clear value grouping, and layered color fields. Blend digital impasto, opaque gouache, and dry-brush marks, retaining hand-painted edges, subtle scumbling, and fine paper grain. Use a muted limited palette built from cream, dusty blue, olive green, ochre, brick red, and charcoal for a warm, restrained, slightly faded print character. Organize the composition around a clear visual focus, pronounced scale contrast, negative space, and leading lines, creating the quiet, expansive, cinematic atmosphere of environment concept art.',
        image: '',
        description: '低饱和大色块、数字水粉与电影感构图的复古极简画风。'
    },
    {
