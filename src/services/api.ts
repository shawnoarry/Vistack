    ...
    const userContent = isImageToPrompt
        ...
        : isCalendarIllustration
          ? [
              ...
              '严格按创作条件中列出的方案 1、2、3 风格路线逐条输出，不得交换、合并或重复路线。',
              '每条 prompt 必须明确体现对应路线的媒介与画面质感，direction 用一句短语概括该路线。',
              '三组必须有清晰的摄影、绘画、印刷、拼贴、纸雕或平面设计方法差异；从文案语义选择具体视觉锚点，不要把三组都退回抽象几何、拼贴或相似的“艺术感”描述。',
              '允许具体人物、自然物、静物、空间和场景。人物可以是背影、侧后方、剪影、局部身体或手部，不要求清晰人脸；人物出现时避免人物主导的套路化恋爱海报、广告化叙事和无意义堆砌。',
              '严格按人物策略执行：避开人物时不得出现人物、人物局部、手部、人脸或可辨认的人形/人体轮廓；允许人物时不限制人物方案数量。people 为 true 表示画面出现人物或可辨认的人体局部。',
              '时间语境只用于调整季节、光线、明暗和色调权重，不要机械添加节日符号。',
              '不要整体忽略作者、作品、出处和文案语义：作品名、书名、专有名词与出处信息可以提供创意线索；但不要机械推断作者国籍或地域，也不要复制作者或既有作品的画风。',
              '不要在结果中复述原文、生成书名或作者署名，也不要让画面出现任何可读文字、数字、日期、Logo、二维码或水印。',
        ...
        messages: [
            {
                ...
                content: isImageToPrompt
                    ...
                    ? [
                        ...
                        '你负责把文案转译成 3 组短、开放、可发散的视觉方向提示词，不负责生成图片，也不需要参考素材图片。',
                        '允许具体人物、自然物、静物、空间和场景；人物可以用背影、侧后方、剪影、局部身体或手部表达，不把人物出现等同于正面露脸。',
                        '人物不是默认主角；避免人物主导的套路化恋爱海报、广告化叙事和无意义堆砌。',
                        '通过摄影、绘画、版画、漫画/绘本、拼贴、纸雕、丝网印刷和实验平面设计等媒介保持三组明显发散，并严格遵守人物策略。',
                        '从作品名、书名、专有名词、出处信息和文案语义提取创意线索；不要机械推断作者国籍或地域，不要复制作者或既有作品的画风，不要输出书名、署名或画面文字。',
